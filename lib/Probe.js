...
var Counter   = require('./utils/probes_utils/Counter.js');
var Histogram = require('./utils/probes_utils/Histogram.js');
var Meter     = require('./utils/probes_utils/Meter.js');
...
Probe.probe = Probe.Probe = function() {
  var self = this;
