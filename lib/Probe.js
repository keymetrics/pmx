...
Probe.probe = function() {
  ...
  if (this.getConf && this.getConf())
    Probe._alert_activated = this.getConf().alert_enabled || false;
  else
  ...
  return {
    ...
    metric : function(opts) {
      ...
      if (opts.alert && Probe._alert_activated == true) {
        // if (self.getConf()[opts.name].threshold)
        //   opts.alert.value = parseInt(self.getConf()[opts.name].threshold);
        Probe._var[opts.name].alert = new Alert(opts.alert, {probe_name : opts.name});
      }
    ...
    counter : function(opts) {
      ...
      if (opts.alert && Probe._alert_activated == true)
        Probe._var[opts.name].alert = new Alert(opts.alert);
