...
Transaction.http = function(opts) {
  ...
  if (Array.isArray(opts)) {
    routes = JSON.parse(JSON.stringify(opts));
    opts = {
      http : true,
  ...
  Proxy.wrap(Module, '_load', function(load) {
      ...
      if (opts.http === false) {
        ...
        return function(file) {
          if (file === 'http' || file === 'https')
            return SimpleHttpWrap(opts.ignore_routes || [], load.__axm_original.apply(this, arguments));
          else
    ...
    return function(file) {
      if (opts.http &&
        ...
        return SimpleHttpWrap(opts.ignore_routes || [], load.apply(this, arguments));
      }
      else
